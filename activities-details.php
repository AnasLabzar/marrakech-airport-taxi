...
<head>
    ...
    <!-- Title -->
    <title>Seamless Tourist Transport Solutions in Marrakech</title>
</head>
...
<body>
    ...
    <div class="container">
        <?php include 'includes/banner/banner-promo.php'; ?>
    </div>
        ...
        <div class="container">
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="gallery-img-wrap">
                                    ...
                                    <a data-fancybox="gallery-01" href="assets/img/innerpage/ski-touring-01.jpg"><i
                                            class="bi bi-eye"></i></a>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            ...
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/innerpage/ski-touring-02.jpg"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="gallery-img-wrap">
                                            ...
                                            <a data-fancybox="gallery-01"
                                                href="assets/img/innerpage/ski-touring-03.jpg"><i
                                                    class="bi bi-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
            ...
            <div class="row g-xl-4 gy-5">
                <div class="col-xl-8">
                    ...
                    <p>Ski touring, also known as backcountry skiing, involves traveling across snow-covered terrain
                        using skis. It's a blend of skiing and hiking, allowing access to remote areas not reachable by
                        ski lifts. Skiers ascend slopes using climbing skins on their skis or specialized equipment like
                        splitboards, then descend using skis. This activity offers a unique opportunity to explore
                        untouched wilderness, experience serene landscapes, and challenge oneself physically and
                        mentally while embracing the thrill of the mountains. Safety measures, including avalanche
                        awareness and carrying appropriate gear, are paramount in ski touring due to the inherent risks
                        of backcountry environments.</p>
                    <h4>Included and Excluded</h4>
                    <div class="includ-and-exclud-area mb-20">
                        <ul>
                            <li><i class="bi bi-check-lg"></i> Ski touring involves exploring remote, off-piste terrains
                                away from ski resorts.</li>
                            <li><i class="bi bi-check-lg"></i> A full-body workout combining skiing, hiking, and
                                endurance.</li>
                            <li><i class="bi bi-check-lg"></i> Engaging in challenging ascents and thrilling descents on
                                various terrains.</li>
                            <li><i class="bi bi-check-lg"></i> Enjoying pristine landscapes and serene natural
                                environments.</li>
                            <li><i class="bi bi-check-lg"></i> Carrying safety gear (avalanche transceivers, shovels,
                                probes) and knowledge of rescue procedures.</li>
                        </ul>
                        <ul class="exclud">
                            <li><i class="bi bi-x-lg"></i> Ski touring typically avoids the amenities and maintained
                                slopes found in ski resorts.</li>
                            <li><i class="bi bi-x-lg"></i> It steers clear of crowded slopes and lift systems.</li>
                            <li><i class="bi bi-x-lg"></i> Ski touring often involves more challenging and varied
                                terrains, less suitable for beginners.</li>
                            <li><i class="bi bi-x-lg"></i> In case of emergencies, immediate assistance may not be
                                readily available compared to ski resorts.</li>
                            <li><i class="bi bi-x-lg"></i> Unlike ski resorts, conditions in backcountry areas can vary
                                significantly and may not be groomed or controlled.</li>
                        </ul>
                    </div>
                    <div class="highlight-tour mb-20">
                        <h4>Highlights of the Tour</h4>
                        <ul>
                            <li><span><i class="bi bi-check"></i></span> Immersion in breathtaking, untouched landscapes
                                away from crowded ski resorts.</li>
                            <li><span><i class="bi bi-check"></i></span> Combining endurance and skill while exploring
                                diverse terrains.</li>
                            <li><span><i class="bi bi-check"></i></span> Accessing pristine, less-traveled areas for a
                                unique adventure.</li>
                            <li><span><i class="bi bi-check"></i></span> Strengthening camaraderie among fellow skiers
                                in a shared outdoor experience.</li>
                            <li><span><i class="bi bi-check"></i></span> Accomplishing challenging ascents and thrilling
                                descents in natural settings.</li>
                            <li><span><i class="bi bi-check"></i></span> Feeling the elements and connecting with the
                                mountains in a profound way.</li>
                            <li><span><i class="bi bi-check"></i></span> Experiencing the freedom of traveling through
                                snowy wilderness on skis.</li>
                        </ul>
                    </div>
                    ...
                    <div class="accordion tour-plan" id="tourPlan">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <ul>
                                        <li><i class="bi bi-check-lg"></i><strong>Morning:</strong> Final gear check and
                                            packing.</li>
                                        <li><i class="bi bi-check-lg"></i><strong>Midday:</strong> Travel to the
                                            destination, ensuring everyone has the necessary equipment and provisions.
                                        </li>
                                        <li><i class="bi bi-check-lg"></i><strong>Afternoon/Evening:</strong> Set up
                                            camp or accommodation, review safety protocols, and plan for the following
                                            days.</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <ul>
                                        ...
                                        <li><i class="bi bi-check-lg"></i><strong>Midday:</strong> Break for lunch and
                                            assess conditions.</li>
                                        <li><i class="bi bi-check-lg"></i><strong>Afternoon:</strong> Continue
                                            exploring, gradually increasing difficulty if the group is comfortable.</li>
                                        <li><i class="bi bi-check-lg"></i><strong>Evening:</strong> Return to the base,
                                ...
                                <div class="accordion-body">
                                    <ul>
                                        <li><i class="bi bi-check-lg"></i><strong>Morning:</strong> Tackle a more
                                            ...
                                            conditions.</li>
                                        <li><i class="bi bi-check-lg"></i><strong>Midday:</strong> Evaluate progress,
                                            take necessary breaks, and ensure safety measures are in place.</li>
                                        <li><i class="bi bi-check-lg"></i><strong>Afternoon:</strong> Enjoy the terrain,
                                            capturing the scenic beauty while advancing in skill and terrain difficulty.
                                        </li>
                                        <li><i class="bi bi-check-lg"></i><strong>Evening:</strong> Reflect on the day's
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                    <ul>
                                        <li><i class="bi bi-check-lg"></i><strong>Morning:</strong> Summit Attempt and
                                            Departure</li>
                                        ...
                                        <li><i class="bi bi-check-lg"></i><strong>Evening:</strong> Pack up, depart for
                            ...
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#travelcollapseOne" aria-expanded="true"
                                            aria-controls="travelcollapseOne">
                                            01. What is ski touring?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="travelheadingOne" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Ski touring is a form of skiing where participants travel across
                                            snow-covered terrain using skis. It often involves traversing backcountry or
                                            off-piste areas, away from ski resorts.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="travelcollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingTwo" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Essential equipment includes touring skis, bindings, climbing skins, poles,
                                            boots suitable for touring, safety gear (avalanche transceiver, shovel,
                                            probe), and appropriate clothing for variable weather conditions.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="travelcollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingThree" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Ski touring involves ascending slopes using skins or other equipment, then
                                            descending using skis. It's more about the journey and exploring off-piste
                                            terrain than the controlled descents found in downhill skiing at resorts.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingFour">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#travelcollapseFour"
                                            aria-expanded="false" aria-controls="travelcollapseFour">
                                            04. Is ski touring safe?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingFour" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Ski touring involves inherent risks associated with backcountry travel,
                                            including avalanches, changing weather conditions, and navigation
                                            challenges. Proper education, avalanche safety training, and carrying
                                            necessary safety gear are crucial for safety.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingFive">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#travelcollapseFive"
                                            aria-expanded="false" aria-controls="travelcollapseFive">
                                            05. Do I need prior skiing experience for ski touring?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingFive" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            While some ski touring routes can be suitable for beginners, having prior
                                            skiing experience, especially in different snow conditions, can be
                                            beneficial for safety and enjoyment.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingSix">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#travelcollapseSix"
                                            aria-expanded="false" aria-controls="travelcollapseSix">
                                            06. Are there guided ski touring trips available?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseSix" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingSix" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Yes, many outdoor adventure companies offer guided ski touring trips led by
                                            experienced guides who can enhance safety, provide local knowledge, and help
                                            plan routes.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingSevene">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#travelcollapseSevene"
                                            aria-expanded="false" aria-controls="travelcollapseSevene">
                                            07. What fitness level is required for ski touring?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseSevene" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingSevene" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Ski touring demands physical fitness, including endurance and strength.
                                            Preparing with cardiovascular exercise, strength training, and skiing
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="travelheadingEight">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#travelcollapseEight"
                                            aria-expanded="false" aria-controls="travelcollapseEight">
                                            08. What should I do in case of an emergency during ski touring?
                                        </button>
                                    </h2>
                                    <div id="travelcollapseEight" class="accordion-collapse collapse"
                                        aria-labelledby="travelheadingEight" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Having a well-thought-out emergency plan, including communication devices,
                                            knowledge of rescue procedures, and first aid skills, is vital. Always
                    ...
                    <div class="review-wrapper">
                        ...
                        <div class="review-box">
                                                                        ...
                                                                        <ul class="star-rating-list">
                                                                            <li>
                                                                                <div class="rating-container"
                                                                                    data-rating="0">
                                                                                    <i
                                                                                        class="bi bi-star-fill star-icon"></i>
                                                                                    <i
                                                                                        class="bi bi-star-fill star-icon"></i>
                                                                                    <i
                                                                                        class="bi bi-star-fill star-icon"></i>
                            ...
                            <a class="primary-btn1" data-bs-toggle="modal" href="#exampleModalToggle" role="button">GIVE
                                A
                                RATING</a>
                        </div>
                                ...
                                <li>
                                    <div class="single-comment-area">
                                        ...
                                        <div class="comment-content">
                                            ...
                                            <p>A solution that we came up with is to think of sanitary pads packaging as
                                                you
                                        ...
                                        <div class="tour-date-wrap mb-50">
                                            ...
                                            <div class="form-inner mb-20">
                                                <div class="form-group">
                                                    <input type="text" name="inOut" placeholder="5 Jan, 2024">
    ...
    <!-- <div class="activitis-page pt-120 mb-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="single-activitis">
                    <div class="activitis-content">
                        <div class="eg-tag2">
                            <span>Nature Tours</span>
                        </div>
                        <h2>Trailblazing Through Nature: Explorations and Activities</h2>
                        <p>Discover nature's wonders through guided hikes, wildlife safaris, and hands-on workshops. Immerse in eco-tours, birdwatching, and outdoor education—connecting with the wilderness for an enriching experience amidst stunning landscapes.</p>
                        <ul>
                            <li>
                        ...
                        <div class="content-bottom-area">
                            ...
                            <a href="https://www.youtube.com/watch?v=MLpWrANjFbI&amp;ab_channel=eidelchteinadvogados" class="video-area video4">
                                <div class="icon">
                    ...
                    <div class="activitis-img">
                        <div class="activitis-img1 mb-25">
                            <img src="assets/img/home1/verticle-tab-img1.png" alt="">
                        </div>
                        <div class="activitis-img2">
                            <img src="assets/img/home1/verticle-tab-img2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                        <div class="footer-widget">
                            ...
                            <div class="single-contact mb-35">
                                ...
                                <a
                                    href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#620b0c040d22071a030f120e074c010d0f"><span
                                        class="__cf_email__"
                                        data-cfemail="2c45424a436c49544d415c4049024f4341">[email&#160;protected]</span></a>
                            </div>
...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/triprex/preview/activities-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Dec 2024 13:52:35 GMT -->
