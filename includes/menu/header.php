        ...
        <div class="main-menu">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    <a href="destination1.html" class="drop-down">Tours & Excursions</a><i class="bi bi-plus dropdown-icon"></i>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children">
                    <a href="#" class="drop-down">Guide</a><i class="bi bi-plus dropdown-icon"></i>
                </li>
                <li>
